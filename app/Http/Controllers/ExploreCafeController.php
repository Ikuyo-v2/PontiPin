...
class ExploreCafeController
{
    ...
    public function create()
    {
        ...
        return view('ExploreCafe.create',
            ['title' => $title]
        );
    }
    ...
    public function update($id)
    {
        ...
        return view('ExploreCafe.update',
            ['title' => $title]
        );
    }
    ...
    public function destroy($id)
    {
        ...
        return view('ExploreCafe.destroy',
            ['title' => $title]
        );
    }
}
